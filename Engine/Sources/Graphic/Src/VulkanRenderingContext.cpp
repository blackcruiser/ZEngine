...
void VulkanRenderingContext::Initialize()
{
...
void VulkanRenderingContext::BeginRendering()
{
...
void VulkanRenderingContext::EndRendering()
{
...
TPtr<VulkanQueue> VulkanRenderingContext::GetQueue(VulkanQueue::EType type)
{
...
TPtr<VulkanDescriptorPool> VulkanRenderingContext::GetDescriptorPool()
{
    return _descriptorPool;
}

TPtr<VulkanCommandBufferManager> VulkanRenderingContext::GetCommandBufferManager()
{
    return _commandBufferManager;
}

TPtr<VulkanBufferManager> VulkanRenderingContext::GetBufferManager()
{
    return _bufferManager;
}

TPtrSet<VulkanGraphicPipeline>& VulkanRenderingContext::GetPipelineCache()
{
