...
VkInstance CreateInstance()
{
    ...
    ZE_CHECK_MSG(result == VkResult::VK_SUCCESS, "Failed to create vulkan instance!");
...
{
    ZE_CHECK_MSG(instance, "instance is empty!");
...
uint32_t FindMemoryType(VkPhysicalDevice physicalDevice, uint32_t typeFilter, VkMemoryPropertyFlags properties)
{
    ...
    ZE_CHECK_MSG(false, "Unable to find memory type");
}
