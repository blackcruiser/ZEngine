...
void RenderingCommandBuffer::BeginRendering()
{
    commandBuffer->Begin();
}

void RenderingCommandBuffer::EndRendering()
{
    commandBuffer->End();
}
...
void RenderingCommandBuffer::SetRenderTargets(TPtr<RenderTargets> renderTargets)
{
